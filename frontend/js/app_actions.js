...
function createAppActions(baseContext) {
    ...
    const inflightGuardMs = typeof INFLIGHT_GUARD_MS === "number" ? INFLIGHT_GUARD_MS : 30_000;
    context.inflightGuardMs = inflightGuardMs;
    const {
        state,
        elements,
        hasTelegramInitData,
    ...
    async function ensureAiLoaded() {
        ...
        await Promise.all([
            context._loadScript("js/api_ai_modal.js?v=20260517-9c5444c"),
            context._loadScript("js/api_ai_render.js?v=20260517-9c5444c"),
            context._loadScript("js/api_ai.js?v=20260517-9c5444c"),
            context._loadScript("js/api_listing_assistant.js?v=20260517-9c5444c"),
        ]);
