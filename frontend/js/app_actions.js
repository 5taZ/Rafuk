...
function createAppActions(baseContext) {
    ...
    async function ensureAiLoaded() {
        ...
        await Promise.all([
            context._loadScript("js/api_ai_modal.js?v=20260514-7a8d9db"),
            context._loadScript("js/api_ai_render.js?v=20260514-7a8d9db"),
            context._loadScript("js/api_ai.js?v=20260514-7a8d9db"),
            context._loadScript("js/api_listing_assistant.js?v=20260514-7a8d9db"),
        ]);
