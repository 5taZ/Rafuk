...
down_revision: str | None = '59ad46ea83ba'
...
def upgrade() -> None:
    ...
    op.add_column(
        "trackers", sa.Column("paused", sa.Boolean(), nullable=True, server_default="false"),
    )
    op.add_column("trackers", sa.Column("pause_reason", sa.String(128), nullable=True))
    op.add_column(
        "trackers", sa.Column("paused_at", sa.DateTime(timezone=True), nullable=True),
    )

    # Enrich tracker events with more metadata
    op.add_column(
        "tracker_events", sa.Column("thumbnail", sa.String(512), nullable=True),
    )
    op.add_column(
        "tracker_events",
