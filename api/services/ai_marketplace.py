...
_CATEGORY_WATCH_OUT: dict[str, list[tuple[str, str]]] = {
    ...
    "phone_accessory": [
        (
            "Совместимость",
            "Уточни, подходит ли аксессуар к твоей модели телефона "
            "— чехлы и стёкла часто не универсальны.",
        ),
        (
            "Оригинальность",
            "Проверь, оригинал ли это: подделки выглядят похоже, "
            "но качество хуже. Попроси фото упаковки и маркировки.",
        ),
        (
            "Состояние",
            "Если б/у — осмотри на потёртости, трещины, деформацию. "
            "Чехол может не защёлкнуться, стекло — иметь сколы.",
        ),
    ],
    "auto_accessory": [
        (
            "Совместимость",
            "Уточни, подходит ли аксессуар к марке, модели и году "
            "твоего авто — размеры и крепления часто отличаются.",
        ),
        (
            "Оригинальность и качество",
            "Проверь материал и бренд: дешёвые аналоги могут быть "
            "токсичными или быстро изнашиваться.",
        ),
        (
            "Состояние и комплект",
            "Если б/у — осмотри на потёртости, деформации и полноту "
            "комплекта (крепёж, провода, инструкция).",
        ),
    ],
    "computer_accessory": [
        (
            "Совместимость",
            "Сверь разъёмы, форм-фактор и требования к питанию/ОС "
            "— не все комплектующие подходят друг к другу.",
        ),
        (
            "Состояние и гарантия",
            "Для б/у комплектующих спроси про гарантию и причину "
            "продажи — майнеры часто продают изношенные видеокарты.",
        ),
        (
            "Оригинальность",
            "Подделки флешек и SSD распространены — проверь реальный "
            "объём и скорость через тест.",
        ),
    ],
    "photo_accessory": [
        (
            "Совместимость",
            "Уточни байонет, диаметр резьбы и тип крепления "
            "— штативы, вспышки и фильтры не универсальны.",
        ),
        (
            "Состояние",
            "Осмотри на царапины на оптических элементах, "
            "люфт в шарнирах и коррозию на металле.",
        ),
        (
            "Комплектность",
            "Проверь наличие крепёжного ключа, чехла, инструкции, "
            "переходников — без них аксессуар теряет ценность.",
        ),
    ],
    "gaming_accessory": [
        (
            "Совместимость",
            "Убедись, что аксессуар работает с твоей платформой "
            "(PS/Xbox/PC/Switch) — многие контроллеры платформоспецифичны.",
        ),
        (
            "Состояние механизмов",
            "Проверь стики на дрифт, триггеры на залипание и вибрацию "
            "— это главные проблемы б/у контроллеров.",
        ),
        (
            "Оригинальность",
            "Поддельные контроллеры и гарнитуры распространены "
            "— сравни вес, текстуру и маркировку с оригиналом.",
        ),
    ],
    "home_accessory": [
        (
            "Размеры и совместимость",
            "Измерь пространство и сверь габариты "
            "— органайзеры и полки часто не подходят по размеру.",
        ),
        (
            "Состояние и чистота",
            "Осмотри на пятна, царапины и запахи — текстиль и пластик "
            "впитывают запахи от предыдущего владельца.",
        ),
        (
            "Комплектность",
            "Проверь наличие крепежа, фурнитуры и инструкции "
            "— без них установка может стать проблемой.",
        ),
    ],
    "bicycle_accessory": [
        (
            "Совместимость",
            "Уточни тип велосипеда (горный/шоссейный/городской) "
            "и диаметр колёс — аксессуары часто не универсальны.",
        ),
        (
            "Состояние",
            "Проверь на коррозию, трещины в пластике и люфт "
            "в подвижных частях — фары и замки часто ломаются.",
        ),
        (
            "Крепёж",
            "Убедись, что в комплекте есть всё для установки "
            "— без крепежа аксессуар бесполезен.",
        ),
    ],
    "watch_accessory": [
        (
            "Совместимость",
            "Уточни размер ремешка (мм) и модель часов "
            "— ремешки Apple Watch разных серий отличаются.",
        ),
        (
            "Оригинальность",
            "Проверь маркировку и качество материала "
            "— подделки ремешков и зарядок очень распространены.",
        ),
        (
            "Состояние",
            "Осмотри ремешок на потёртости и растяжение, "
            "зарядку — на перегибы и окисление контактов.",
        ),
    ],
    "laptop": [
        (
    ...
    "real_estate": [
        (
            ...
            "Проверь правоустанавливающие документы, обременения, залоги и "
            "зарегистрированных лиц — это главный риск при сделке.",
        ),
        (
            "Состояние и ремонт",
            "Осмотри жильё лично: свежий ремонт может скрывать проблемы с "
            "трубами, электрикой и планировкой.",
        ),
        (
            "Локация и инфраструктура",
            "Уточни транспорт, школы, магазины, шум и экологию района — "
            "это влияет на цену сильнее, чем косметический ремонт.",
        ),
    ],
    "motorcycle": [
        (
            "Двигатель и пробег",
            "Слушай мотор на холодную и под нагрузкой, сверяй пробег с состоянием.",
        ),
        (
            "Рама и подвеска",
            "Осмотри раму на трещины и сварку, проверь вилку и амортизаторы на течи.",
        ),
        (
            "Документы и сезон",
            "Уточни документы, историю ДТП и помни: зимой мотоциклы дешевле на 15-25%.",
        ),
    ],
    "tv": [
        (
            "Матрица и подсветка",
            "Проверь битые пиксели, полосы и равномерность подсветки — "
            "дефекты экрана не лечатся.",
        ),
        (
            "Порты и SMART TV",
            "Подключи по HDMI, проверь USB и работу SMART-платформы без зависаний.",
        ),
        (
            "Возраст модели",
            "Узнай год выпуска: каждый дополнительный год — потеря 10-15% стоимости.",
        ),
    ],
    "console": [
        (
            "Контроллеры и дисковод",
            "Проверь стики на дрифт, триггеры и вибрацию; если есть дисковод — "
            "попробуй прочитать диск.",
        ),
        (
            "Онлайн-статус и прошивка",
            "Убедись, что консоль не забанена и аккаунт чистый — "
            "бан онлайн обесценивает приставку на 20-30%.",
        ),
        (
            "Комплект и гарантия",
            "Уточни наличие оригинальных проводов, контроллеров и действующей гарантии.",
        ),
    ],
    "bicycle": [
        (
            "Рама и вилка",
            "Осмотри раму на трещины и коррозию, проверь вилку на люфт и ход.",
        ),
        (
            "Трансмиссия и тормоза",
            "Проверь износ цепи, кассеты и колодок — замена стоит 50-100 BYN.",
        ),
        (
            "Колёса и сезон",
            "Проверь восьмёрки, спицы и остаток протектора; осенью велосипеды дешевле.",
        ),
    ],
    "appliance": [
        (
            "Работоспособность",
            "Попроси включить все режимы и послушай работу — посторонние звуки = ремонт.",
        ),
        (
            "Уплотнители и фильтры",
            "Для холодильников и стиралок проверь уплотнители, для пылесосов — фильтры.",
        ),
        (
            "Возраст и гарантия",
            "Уточни год выпуска и гарантию: каждый год без гарантии — -10-15% стоимости.",
        ),
    ],
    "furniture": [
        (
            "Каркас и механизмы",
            "Проверь раскладывание, ящики, петли — скрип и люфт означают износ каркаса.",
        ),
        (
            "Обивка и чистота",
            "Осмотри обивку на пятна, потёртости и разрывы — химчистка стоит дорого.",
        ),
        (
            "Размеры и доставка",
            "Сверь габариты с дверными проёмами и уточни, кто оплачивает доставку.",
        ),
    ],
    "construction": [
        (
            "Характеристики и объём",
            "Сверь марку, партию и точный объём — разнобой тона или партии = брак.",
        ),
        (
            "Срок годности и хранение",
            "У смесей, красок и клея ограниченный срок; нарушенная упаковка = риск.",
        ),
        (
            "Доставка и самовывоз",
            "Уточни условия погрузки и доставки — логистика стройматериалов съедает экономию.",
        ),
    ],
    "default": [
        (
...
_CATEGORY_CHECKLIST: dict[str, list[str]] = {
    ...
    "real_estate": [
        "Проверь правоустанавливающие документы, обременения и залоги.",
        "Осмотри жильё лично: трубы, электрика, стены, окна, двери.",
        "Уточни коммунальные платежи, счётчики и кто их оплачивает.",
        "Сверь метраж, планировку и этаж с объявлением.",
        "Для аренды: залог, комиссия, срок договора, включена ли коммуналка.",
    ],
    "motorcycle": [
        "Слушай двигатель на холодную и под нагрузкой — посторонние звуки = ремонт.",
        "Осмотри раму на трещины, сварку и коррозию.",
        "Проверь цепь, звёзды, тормоза, резину и подвеску на течи.",
        "Уточни пробег, историю ДТП и документы.",
        "Помни: зимой мотоциклы дешевле на 15-25%, весной — дороже.",
    ],
    "tv": [
        "Включи и проверь матрицу: битые пиксели, полосы, равномерность подсветки.",
        "Подключи по HDMI, проверь USB и работу SMART TV без зависаний.",
        "Послушай звук — хрип динамиков = замена.",
        "Уточни год выпуска и наличие оригинального пульта и подставки.",
        "Сравни цену с новой моделью того же класса.",
    ],
    "console": [
        "Проверь контроллеры: стики без дрифта, триггеры, вибрация.",
        "Если есть дисковод — попробуй прочитать диск.",
        "Убедись, что консоль не забанена онлайн и аккаунт чистый.",
        "Проверь HDMI, вентилятор и температуру при нагрузке.",
        "Уточни комплект: провода, контроллеры, игры и гарантия.",
    ],
    "bicycle": [
        "Осмотри раму на трещины, вмятины и коррозию.",
        "Проверь вилку на люфт, ход и течи масла.",
        "Прокрути педали и проверь переключение передач и цепь.",
        "Проверь тормоза (колодки, диски, гидравлика) и колёса (восьмёрки, спицы).",
        "Уточни ростовку и сезон — осенью велосипеды дешевле 15-20%.",
    ],
    "appliance": [
        "Включи все режимы и послушай работу — посторонние звуки = проблема.",
        "Для холодильника: проверь уплотнители и температуру в камерах.",
        "Для стиральной машины: осмотри барабан, уплотнители и фильтр.",
        "Уточни год выпуска и гарантию — каждый год без гарантии минус 10-15%.",
        "Проверь кабель, вилку и отсутствие ржавчины на корпусе.",
    ],
    "furniture": [
        "Попробуй разложить и собрать — скрип и люфт = износ каркаса.",
        "Осмотри обивку на пятна, потёртости и разрывы.",
        "Проверь ящики, петли и механизмы на плавность хода.",
        "Сверь габариты с дверными проёмами и комнатой.",
        "Уточни возможность доставки и кто её оплачивает.",
    ],
    "construction": [
        "Сверь марку, партию и точные характеристики с заявленными.",
        "Проверь срок годности у смесей, красок и клея.",
        "Осмотри упаковку: нарушенная = риск порчи материала.",
        "Уточни объём/остаток и возможность самовывоза или доставки.",
        "Сравни цену с гипермаркетами — стройматериалы часто дешевле в рознице.",
    ],
    "default": [
